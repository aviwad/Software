...
def penalty_kick_play_test_setup(ball_initial_pos, blue_bots, simulated_test_runner):
    """
        Setup for Penalty Kick Play Test
...
def test_corner_kick_play_bottom_left(simulated_test_runner):
    ...
    simulated_test_runner.run_test(
        setup=lambda ball_and_bots_pos: penalty_kick_play_test_setup(
...
def test_corner_kick_play_top_right(simulated_test_runner):
    # TODO- #2781 Validation
    simulated_test_runner.run_test(
        setup=lambda ball_and_bots_pos, runner=simulated_test_runner: penalty_kick_play_test_setup(
            ball_and_bots_pos["ball_initial_pos"],
            ball_and_bots_pos["blue_bots"],
            simulated_test_runner,
        ),
